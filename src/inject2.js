...
async function downloadFile(message) {
    ...
    if (message.type === "document") {
        ...
        console.log("couldn't recognize message type. Skipping download")
        return
    }
...
//                     console.log("Processing webhook from block")
                ...
                setTimeout(() => {
                    ...
                    if (message.body == "!ping") {
                        try {
                            ...
                            var d1 = d[0].querySelectorAll('._2nY6U')
                            console.log(d1);
                            d1[0].style.backgroundColor = "#8c880c";
                            // d[0].style.backgroundColor = "#8c880c";
...
WAPI.setupFeaturePage = function () {
    ...
    if (presentButton != true) {
        ...
        newFeatureButton.innerHTML = `
            <button id="featureButton" onClick="openPopup()">BOT</button>
        `;
    ...
    newPopup.innerHTML = `
           ...
           <ul>
            <li>
                ...
                <input id = "blurName" onclick = "handleFeature(this);" type="checkbox"> 
            </li>
            <li>
                <label style="font-size: 20px">Blur photo</label> 
                <input id = "blurPhoto" onclick = "handleFeature(this);" type="checkbox">
            </li>
            <li>
                <label style="font-size: 20px">Blur chat</label>
                <input id = "blurChat" onclick = "handleFeature(this);" type="checkbox">
            </li>
            <li>
                <label style="font-size: 20px">Blur recent messages</label>
                <input id = "blurRecentMessages" onclick = "handleFeature(this);" type="checkbox">
            </li>
            <li>
            ...
            <li>
                ...
                <input id = "ActiveSpamFilter" onclick = "handleFeature(this);" type="checkbox">
            </li>
        </ul>
